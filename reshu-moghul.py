...
series_uniqueOrderID = df["Order ID"].unique()
...
def concatenateAddress(address1, address2):
...
for orderID in series_uniqueOrderID:
	...
	shipping_address = concatenateAddress(df_orderID["Shipping Address Line 1"].tolist()[0], df_orderID["Shipping Address Line 2"].tolist()[0])
	...
	pdf.cell(200, 7, txt = "Name: " + name, ln = 1, align = 'L')
	pdf.set_x(x= x_position)
